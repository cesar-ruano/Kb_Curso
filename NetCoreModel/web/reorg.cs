/*
       ...
       Generated on: 6/19/2020 10:12:7.18
...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void CreateTSueldo( )
      {
         String cmdBuffer = "" ;
         /* Indices for table TSueldo */
         try
         {
            cmdBuffer=" CREATE TABLE [TSueldo] ([SueldoId]  smallint NOT NULL , [SueldoMonto]  decimal( 17, 2) NOT NULL , PRIMARY KEY([SueldoId]))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         catch ( Exception ex )
         {
            try
            {
               DropTableConstraints( "[TSueldo]") ;
               cmdBuffer=" DROP TABLE [TSueldo] "
               ;
               RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
               RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
               RGZ.ExecuteStmt() ;
            ...
            catch ( Exception sqlex1 )
            {
               ...
               catch ( Exception sqlex2 )
               {
                  ...
                  {
                     DropTableConstraints( "[TSueldo]") ;
                     cmdBuffer=" DROP FUNCTION [TSueldo] "
                     ;
                     RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
      ...
      public void CreateTPuestos( )
      {
         ...
         try
         {
            cmdBuffer=" CREATE TABLE [TPuestos] ([PuestoId]  smallint NOT NULL , [PuestoDsc]  nvarchar(40) NOT NULL , [SueldoId]  smallint NOT NULL , PRIMARY KEY([PuestoId]))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         try
         {
            cmdBuffer=" CREATE NONCLUSTERED INDEX [ITPUESTOS1] ON [TPuestos] ([SueldoId] ) "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         {
            cmdBuffer=" DROP INDEX [ITPUESTOS1] ON [TPuestos] "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_MASKNOTFOUND | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      public void CreateTEmpleado( )
      {
         ...
         try
         {
            cmdBuffer=" CREATE TABLE [TEmpleado] ([EmpleadoId]  smallint NOT NULL , [EmpleadoNombre]  nvarchar(30) NOT NULL , [EmpleadoFechaNacimiento]  datetime NOT NULL , [PuestoId]  smallint NOT NULL , PRIMARY KEY([EmpleadoId]))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      public void RITPuestosTSueldo( )
      {
         String cmdBuffer ;
         try
         {
            cmdBuffer=" ALTER TABLE [TPuestos] ADD CONSTRAINT [ITPUESTOS1] FOREIGN KEY ([SueldoId]) REFERENCES [TSueldo] ([SueldoId]) "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         catch ( Exception ex )
         {
            try
            {
               cmdBuffer=" ALTER TABLE [TPuestos] DROP CONSTRAINT [ITPUESTOS1] "
               ;
               RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
               RGZ.ErrorMask = GxErrorMask.GX_MASKNOTFOUND | GxErrorMask.GX_MASKLOOPLOCK;
               RGZ.ExecuteStmt() ;
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( tableexist("TSueldo",sSchemaVar) )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_table_exist", new   object[]  {"TSueldo"}) ) ;
            return false ;
         }
         return true ;
      }
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "CreateTSueldo" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 2 ,  "CreateTPuestos" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 3 ,  "CreateTEmpleado" , new Object[]{ });
      }

      private void ExecuteOnlyRisReorganization( )
      {
         ReorgExecute.RegisterBlockForSubmit( 4 ,  "RITEmpleadoTPuestos" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 5 ,  "RITPuestosTSueldo" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"TSueldo", ""}) );
         GXReorganization.SetMsg( 2 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"TPuestos", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTPuestos" ,  "CreateTSueldo" );
         GXReorganization.SetMsg( 3 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"TEmpleado", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTEmpleado" ,  "CreateTPuestos" );
      }

      private void SetPrecedenceris( )
      {
         GXReorganization.SetMsg( 4 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"[ITEMPLEADO1]"}) );
         ReorgExecute.RegisterPrecedence( "RITEmpleadoTPuestos" ,  "CreateTEmpleado" );
         ReorgExecute.RegisterPrecedence( "RITEmpleadoTPuestos" ,  "CreateTPuestos" );
         GXReorganization.SetMsg( 5 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"[ITPUESTOS1]"}) );
         ReorgExecute.RegisterPrecedence( "RITPuestosTSueldo" ,  "CreateTPuestos" );
         ReorgExecute.RegisterPrecedence( "RITPuestosTSueldo" ,  "CreateTSueldo" );
      }
